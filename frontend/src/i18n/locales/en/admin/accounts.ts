export default {
    accounts: {
      traffic: {
        "title": "Optional traffic controls and observations",
        "description": "Off by default. Strict RPM shares one budget per account. Concurrency recommendations are advisory and never change the fixed cap. Initial values are not upstream quotas.",
        "grok": "Grok realtime audio supports session observations only. Strict RPM rejects realtime audio connections; HTTP audio remains available.",
        "strict": "Enable strict RPM",
        "rpm": "Requests per minute",
        "burst": "Burst allowance",
        "budgetHint": "Rolling 60-second ceiling, including bursts. HTTP requests, tests and retries share the budget. OpenAI WS counts each response.create turn.",
        "observe": "Enable concurrency recommendations",
        "min_concurrency": "Minimum recommendation",
        "failure_threshold": "Failure threshold",
        "failure_window_seconds": "Failure window (seconds)",
        "recovery_seconds": "Recovery period (seconds)",
        "observeHint": "Recommend halving after repeated 429 / 5xx errors; recover gradually after a healthy period and at least 3 successes. Fixed concurrency {limit} remains unchanged.",
        "saveHint": "Saved with the other account settings. Turn switches off to disable.",
        "loading": "Refreshing…",
        "refresh": "Refresh saved configuration status",
        "unavailable": "Observations unavailable. Strict RPM pauses new requests when its budget cannot be checked; observation-only mode continues during telemetry cache outages.",
        "inactive": "The saved configuration has observations disabled.",
        "duration": "Average response duration",
        "statsHint": "Last minute is a rolling window. Cumulative counters restart when the cache expires or resets.",
        "effective_concurrency": "Effective concurrency",
        "recommended_concurrency": "Recommended concurrency",
        "in_flight": "In flight",
        "requests_last_minute": "Requests in last minute",
        "upstream_429": "Upstream 429",
        "upstream_5xx": "Upstream 5xx",
        "rejected_rpm": "Local RPM denials"
},
