...
// RecoverAccountAfterSuccessfulTest only observes this probe. A successful
// probe cannot clear unrelated model limits or newer concurrent failures.
// Administrators may explicitly recover an account with RecoverAccountState.
